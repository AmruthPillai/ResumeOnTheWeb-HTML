...
$.fn.preload = function () {
  this.each(function () {
    $('<img />')[0].src = 'https://amruthpillai.com/images/photos/' + this + '.jpg';
  });
};

var photos = ['IMG_3522', 'IMG_1880', 'IMG_8295', 'IMG_5184', 'IMG_8286', 'IMG_4861'];
...
$(document).ready(function () {
  ...
  setInterval(function () {
    $('.hexagon').css({ 'background-image': 'url(\'https://amruthpillai.com/images/photos/' + photos[i] + '.jpg\')' });
    i++;
...
$(function () {
  $('#contact-form').submit(function (e) {
    ...
    $.ajax({
      type: 'POST',
      data: form_data,
      url: 'https://www.amruthpillai.com/contact.php',
